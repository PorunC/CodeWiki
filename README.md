...
- TypeScript backend package: `codewiki-backend`, with `codewiki`,
...
`codewiki-mcp`, plus library exports `codewiki-backend`,
`codewiki-backend/server`, and `codewiki-backend/mcp`.
